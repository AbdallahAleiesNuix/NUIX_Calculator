...
public class Calculator_StepDefinition extends WebDriverUtils {
    ...
    public void the_user_is_on_the_Calculator_app() {
        ...
        switch (env) {
            ...
            case "production":
                ...
                break;
            default:
                System.out.println("Invalid environment. Only the following environments are supported: staging, production.");
                System.exit(0);
        }
    }
    ...
    public void the_user_performs_the_following_operation(String operation) {
        calc.performOp(operation);
    }

    @Then("The user verifies the result is {string}")
    public void the_user_verifies_the_result_is(String result) throws InterruptedException {
        Thread.sleep(5000);
    ...
    public void the_user_verifies_all_numbers_work_on_the_calculator() {
        calc.verifyAllNumbersAreFunctional();
    }
